...
const SkillsList = () => {
  ...
  const skills = {
    ...
    'Mobile Development': [
      ...
      'Development with Android Studio & Expo',
    ],
    '3D Development': [
      'Level design & Programming',
      'World bulding & Interior design with Twinmotion',
      'Development with Unreal Engine 5',
    ],
    'UI/UX Design': [
  ...
  return (
    <div id="skills" className="text-left pt-3 md:pt-9">
      <h3 className="text-[var(--white)] text-3xl md:text-4xl font-semibold md:mb-6">Skills</h3>
